...
then
	...
	then
	    ...
	    mv build/out/unita-*.tar.gz build/out/src/unita-*.tar.gz ../qtum-binaries/${VERSION}
	fi
	# Windows
	if [[ $windows = true ]]
	then
	    ...
	    mv build/out/unita-*-win-unsigned.tar.gz inputs/unita-win-unsigned.tar.gz
	    mv build/out/unita-*.zip build/out/unita-*.exe ../qtum-binaries/${VERSION}
	fi
	# Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    mv build/out/unita-*-osx-unsigned.tar.gz inputs/unita-osx-unsigned.tar.gz
	    mv build/out/unita-*.tar.gz build/out/unita-*.dmg ../qtum-binaries/${VERSION}
	fi
	popd
...
then
	...
	then
	    ...
	    mv build/out/unita-*win64-setup.exe ../qtum-binaries/${VERSION}
	    mv build/out/unita-*win32-setup.exe ../qtum-binaries/${VERSION}
	fi
	# Sign Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    mv build/out/unita-osx-signed.dmg ../qtum-binaries/${VERSION}/unita-${VERSION}-osx.dmg
	fi
	popd
