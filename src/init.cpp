...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-chain=<chainid>", _("The chainid for each Unita blockchain is defined on http://chain.unita.network/. The corresponding configuration file would be downloaded to the local datadir when you start a blockchain for the first time."));
    ...
    strUsage += HelpMessageOpt("-rpcalloworigin=<origin>", _("Allow JSON-RPC connections from cross origin websites. Valid for <origin> are a URL (e.g. http://localhost) or *. This option can be specified multiple times"));
